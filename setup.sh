...
install_docker(){
    ...
    sudo yum -qqy update
    DEBIAN_FRONTEND=noninteractive sudo -E yum -qqy -o Dpkg::Options::="--force-confdef" -o Dpkg::Options::="--force-confold" upgrade
    sudo yum -yy install apt-transport-https ca-certificates curl software-properties-common wget pwgen
